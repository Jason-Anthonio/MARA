"""
Launch file for marav1.

Usage:
    ros2 launch marav1_description display.launch.py
    ros2 launch marav1_description display.launch.py namespace:=robot1
"""
...
def generate_launch_description():
    pkg_dir = get_package_share_directory('marav1_description')

    xacro_file = os.path.join(pkg_dir, 'urdf', 'marav1.urdf.xacro')
